<nav aria-label="blue" x-data="{ open: false }"
    ...
    <div class="flex items-center gap-3">
        <x-button type="button" class="md:hidden" iconOnly variant="blue" srText="Toggle dark mode"
            @click="toggleTheme">
    ...
    {{-- boton  --}}
    <div class="flex items-center gap-3">
        <x-button type="button" class="hidden md:inline-flex" iconOnly variant="blue" srText="Toggle dark mode"
            @click="toggleTheme">
            <x-heroicon-o-moon x-show="!isDarkMode" aria-hidden="true" class="w-6 h-6" />
            <x-heroicon-o-sun x-show="isDarkMode" aria-hidden="true" class="w-6 h-6" />
        </x-button>
...
<div class="fixed inset-x-0 bottom-0 flex items-center justify-between px-4 py-4 sm:px-6 transition-transform duration-500 bg-white md:hidden dark:bg-dark-eval-1"
    ...
    {{-- buscador --}}
    <x-button type="button" iconOnly variant="blue" srText="Search">
    ...
    {{-- sidebar --}}
    <x-button type="button" iconOnly variant="blue" srText="Open main menu"
